...
var wms = new WaveMemoryStreak()
console.log("should be 0.33, 0.33, 0.33");
console.log( wms.getProb());
wms.AddMove('R');
console.log(wms.getProb());
wms.AddMove('R');
console.log(wms.getProb());
...
var p2 = new probVector (1, 2, 3);
console.log(p2);
var p3 = p2.multiplyBy(3);
console.log(p3);
var p4 =p3.getCounterMove();
console.log(p4);
var p5 = p4.add(p2);
console.log(p5)
console.log(p5.getNormalised())
console.log(p5.multiplyBy(0).getNormalised());
