...
let games = args.games ? process.argv[4]: 100;
...
function playGames(gamesRemaining, p1Score, p2Score){
    ...
    if (gamesRemaining > 0){
        play(1, 2, cliRunnerClient, cliRunnerClient, options, console)
            .then(output => {
                ...
                playGames(gamesRemaining - 1, p1Score, p2Score);
...
class Game {
    ...
    updateGamestate(moves) {
        this.dynamite[1],this.dynamite[2]
        moves[1], moves[2];
